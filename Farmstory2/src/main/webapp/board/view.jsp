...
<section id="board" class="view">
    ...
    <table>
        ...
        <tr>
            <td>첨부파일</td>
            <td>
                <a href="/Farmstory2/proc/download.jsp?fseq=<%= article.getFb().getFseq() %>"><%= article.getFb().getOriName() %></a>
    ...
    <div>
    	<% if(uid.equals(article.getUid())){ %>
        	<a href="/Farmstory2/board/proc/deleteProc.jsp?seq=<%= article.getSeq() %>&uri=<%= uri %>" class="btnDelete">삭제</a>
    ...
    <section class="commentList">
        ...
        <% for(ArticleBean comment : comments){ %> 
         <article class="comment">
             ...
             <div>
                 <a href="/Farmstory2/board/proc/deleteCommentProc.jsp?parent=<%= comment.getParent() %>&seq=<%= comment.getSeq() %>&uri=<%= uri %>" class="btnCommentDel">삭제</a>
